...
require './university_lab/ui/main_window'
require './university_lab/repositories/student_repository'
require './university_lab/repositories/adapters/db_source_adapter'
